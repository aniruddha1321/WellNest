...
const AddSleepLog = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({ duration: '', sleepTime: '', wakeUpTime: '', notes: '' })
      navigate('/sleep-logs')
    } catch (error) {
      ...
      <div className="container">
        ...
        >
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', width: '100%' }}>
            <div>
              <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '500' }}>Sleep Time</label>
              <input
                type="time"
                name="sleepTime"
            ...
            <div>
              <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '500' }}>Wake Up Time</label>
              <input
                type="time"
                name="wakeUpTime"
