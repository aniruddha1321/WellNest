...
const WATER_API_URL = 'http://localhost:8081/api/water-intake'
const WORKOUT_API_URL = 'http://localhost:8081/api/workouts'
const SLEEP_API_URL = 'http://localhost:8081/api/sleep'
const MEAL_API_URL = 'http://localhost:8081/api/meals'
